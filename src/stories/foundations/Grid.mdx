...
<div className="relative w-full overflow-x-auto border border-border-default rounded bg-bg-canvas mb-12 p-8">
  <div className="min-w-[800px] flex flex-col gap-4">
    ...
    {/* Labels Row - Using flex justify-between */}
    <div className="flex justify-between items-start h-12 text-xs font-mono text-text-secondary mb-2 px-4">
      <div className="flex flex-col items-center">
        <span className="whitespace-nowrap mb-1">Margin</span>
        <div className="h-4 w-px bg-text-secondary/50"></div>
      </div>
      <div className="flex flex-col items-center">
        <span className="whitespace-nowrap mb-1">Gutter</span>
        <div className="h-4 w-px bg-text-secondary/50"></div>
      </div>
      <div className="flex flex-col items-center">
        <span className="whitespace-nowrap mb-1">Column</span>
        <div className="h-4 w-px bg-text-secondary/50"></div>
      </div>
      <div className="flex flex-col items-center">
        <span className="whitespace-nowrap mb-1">Margin</span>
    ...
    {/* Color Legend */}
    <div className="flex gap-6 text-[10px] text-text-secondary mt-4">
      <div className="flex items-center gap-2">
        <div className="w-4 h-4 bg-success-500/20 border border-success-500/30"></div>
        <span>Margin</span>
      </div>
      <div className="flex items-center gap-2">
        <div className="w-4 h-4 bg-red-500/20 border border-red-500/10"></div>
        <span>Column</span>
      </div>
      <div className="flex items-center gap-2">
        <div className="w-4 h-4 bg-bg-surface border border-text-disabled/20"></div>
        <span>Gutter</span>
      </div>
    </div>
  </div>
