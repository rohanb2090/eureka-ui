import{j as e}from"./jsx-runtime-BYYWji4R.js";import{useMDXComponents as n}from"./index-DUy19JZU.js";import{M as o}from"./index-cHjSVTY0.js";import"./index-ClcD9ViR.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./iframe-Jlnq8aWV.js";import"./index-BUAr5TKG.js";import"./index-Bhelpi4i.js";import"./index-DrFu-skq.js";function a(d){const l={code:"code",div:"div",h1:"h1",h2:"h2",li:"li",p:"p",strong:"strong",ul:"ul",...n(),...d.components};return e.jsxs(e.Fragment,{children:[e.jsx(o,{title:"Foundations/Elevation"}),`
...
`,e.jsx("div",{className:"bg-slate-200 p-8 rounded-xl border border-slate-300 mb-12",children:e.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8",children:[{level:0,shadow:"none",label:"No Shadow"},{level:1,shadow:"shadow-sm",label:"Shadow SM"},{level:2,shadow:"shadow",label:"Shadow"},{level:3,shadow:"shadow-md",label:"Shadow MD"},{level:4,shadow:"shadow-lg",label:"Shadow LG"},{level:5,shadow:"shadow-xl",label:"Shadow XL"}].map(s=>e.jsxs(l.div,{className:"flex flex-col items-center",children:[e.jsx(l.div,{className:`w-32 h-32 bg-white rounded-lg ${s.shadow} flex items-center justify-center text-xs text-slate-600 font-medium border border-slate-200`,children:s.label}),e.jsxs(l.div,{className:"mt-2 text-xs font-semibold text-slate-700",children:["Level ",s.level]})]},s.level))})}),`
`,e.jsx(l.h2,{id:"dark-mode-preview",children:"Dark Mode Preview"}),`
`,e.jsx("div",{className:"bg-neutral-900 p-8 rounded-xl border border-neutral-800 mb-12",children:e.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8",children:[{level:0,shadow:"none",label:"No Shadow"},{level:1,shadow:"shadow-sm",label:"Shadow SM"},{level:2,shadow:"shadow",label:"Shadow"},{level:3,shadow:"shadow-md",label:"Shadow MD"},{level:4,shadow:"shadow-lg",label:"Shadow LG"},{level:5,shadow:"shadow-xl",label:"Shadow XL"}].map(s=>e.jsxs(l.div,{className:"flex flex-col items-center",children:[e.jsx(l.div,{className:`w-32 h-32 bg-neutral-800 rounded-lg ${s.shadow} shadow-black border border-neutral-700 flex items-center justify-center text-xs text-neutral-400 font-medium`,children:s.label}),e.jsxs(l.div,{className:"mt-2 text-xs font-semibold text-neutral-400",children:["Level ",s.level]})]},s.level))})}),`
...
| `,e.jsx(l.strong,{children:"5"})," | 12dp+ | ",e.jsx(l.code,{children:"shadow-xl"})," | Large Dialogs |"]})]})}function g(d={}){const{wrapper:l}={...n(),...d.components};return l?e.jsx(l,{...d,children:e.jsx(a,{...d})}):a(d)}export{g as default};
