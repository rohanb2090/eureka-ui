import{j as e}from"./jsx-runtime-BYYWji4R.js";import{useMDXComponents as i}from"./index-DUy19JZU.js";import{M as d}from"./index-UHG6BjQU.js";import"./index-ClcD9ViR.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./iframe-CJy-XKtk.js";import"./index-BUAr5TKG.js";import"./index-Bhelpi4i.js";import"./index-DrFu-skq.js";function n(r){const s={blockquote:"blockquote",code:"code",div:"div",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...i(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(d,{title:"Foundations/Grid System"}),`
...
`,e.jsx("div",{className:"relative w-full overflow-x-auto border border-border-default rounded bg-bg-canvas mb-12 p-8",children:e.jsxs("div",{className:"min-w-[800px] flex flex-col gap-4",children:[e.jsxs("div",{className:"flex relative h-8 text-xs font-mono text-text-secondary",children:[e.jsxs("div",{className:"absolute left-4 flex flex-col items-center",children:[e.jsx("span",{children:"Margin"}),e.jsx("div",{className:"h-2 w-px bg-text-secondary/30"})]}),e.jsxs("div",{className:"absolute left-1/4 flex flex-col items-center",children:[e.jsx("span",{children:"Column"}),e.jsx("div",{className:"h-2 w-px bg-text-secondary/30"})]}),e.jsxs("div",{className:"absolute left-[20%] flex flex-col items-center",children:[e.jsx("span",{children:"Gutter"}),e.jsx("div",{className:"h-2 w-px bg-text-secondary/30"})]}),e.jsxs("div",{className:"absolute right-4 flex flex-col items-center",children:[e.jsx("span",{children:"Margin"}),e.jsx("div",{className:"h-2 w-px bg-text-secondary/30"})]})]}),e.jsxs("div",{className:"flex w-full h-64 border border-text-disabled/20 relative",children:[e.jsx("div",{className:"w-8 h-full bg-success-500/20 border-r border-success-500/30 flex-shrink-0 flex items-center justify-center"}),e.jsx("div",{className:"flex-1 grid grid-cols-12 gap-4 h-full bg-bg-surface",children:Array.from({length:12}).map((l,t)=>e.jsx(s.div,{className:"bg-red-500/20 h-full border-x border-red-500/10 hover:bg-red-500/30 transition-colors"},t))}),e.jsx("div",{className:"w-8 h-full bg-success-500/20 border-l border-success-500/30 flex-shrink-0 flex items-center justify-center"})]}),e.jsxs("div",{className:"flex justify-between text-[10px] text-text-secondary font-mono border-t border-text-disabled/20 pt-2 mt-2",children:[e.jsx("span",{children:"Fluid Space"}),e.jsx("span",{children:"1280px / 1440px / 1920px"}),e.jsx("span",{children:"Fluid Space"})]})]})}),`
