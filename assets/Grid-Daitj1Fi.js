import{j as e}from"./jsx-runtime-BYYWji4R.js";import{useMDXComponents as t}from"./index-DUy19JZU.js";import{M as d}from"./index-BGBLRcHN.js";import"./index-ClcD9ViR.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./iframe-DP8Cy_Ib.js";import"./index-BUAr5TKG.js";import"./index-Bhelpi4i.js";import"./index-DrFu-skq.js";function i(r){const s={blockquote:"blockquote",code:"code",div:"div",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...t(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(d,{title:"Foundations/Grid System"}),`
...
`,e.jsx("div",{className:"w-full overflow-x-auto border border-border-default rounded bg-bg-canvas mb-12",children:e.jsx("div",{className:"min-w-[800px] grid grid-cols-12 gap-2 p-4",children:Array.from({length:12}).map((a,n)=>e.jsxs(s.div,{className:"col-span-1 h-32 bg-action-primary/10 border border-dashed border-action-primary flex items-center justify-center text-xs text-text-secondary font-mono",children:["Col ",n+1]},n))})}),`
